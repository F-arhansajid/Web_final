              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    ...
                    <p>
                    Boi Ghor is an online platfrom where you can buy, rent, and sell books. <br>
      ...
      <div class="container ">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box"><a class="nav-link" href="fiction.php">
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              ...
              <div class="img-box"><a class="nav-link" href="classic.php">
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box"><a href="thriller.php">
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box"><a href="romance.php">
          ...
          <div class="col-sm-6 col-md-4 ">
            <div class="box ">
              <div class="img-box"><a href="fantasy.php">
      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          <div class="client_container ">
            <div class="detail-box">
              <p>
              Boi Ghor allowed me to rent books at the cheapest price. Now I can read without spending too much!
              </p>
              <span>
        ...
        <div class="col-md-6 mx-auto">
          <div class="client_container ">
            <div class="detail-box">
              <p>
                Being a working person, I barely get time to go out for shopping for which I stopped reading books as buying them was a hassle. Thanks to Boi Ghor, now I can browse through a shop while resting on my bed.
              </p>
              <span>
                <i class="fa fa-quote-left" aria-hidden="true"></i>
              </span>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 info-col">
          <div class="info_detail">
            ...
            <p>
              Established in Boi Ghor, Boi Ghor has been one of the most well known bookshops for readers.
            </p>
